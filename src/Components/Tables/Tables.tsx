...
export const ScrollTableHead =({ children }:Props) =>{
     return (
       <thead className=" border-b sticky top-0 z-30  ">
         <tr className="scrollTableHead pl-3 pr-6 py-2 text-left flex justify-between text-[#5F6D7E] font-bold ">{children}</tr>
       </thead>
     );
   }
   ...
   export const ScrollTableBody =({ children }:Props) =>{
     return (
       <tbody className=" bg-white text-left border-b">
          {children}
           </tbody>
     );
   }
